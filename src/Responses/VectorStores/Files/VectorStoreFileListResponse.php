...
final class VectorStoreFileListResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     *
     * @param  array{object: string, data: array<int, array{id: string, object: string, usage_bytes: int, created_at: int, vector_store_id: string, status: string, attributes: array<string, string>, last_error: ?array{code: string, message: string}, chunking_strategy?: array{type: 'static', static: array{max_chunk_size_tokens: int, chunk_overlap_tokens: int}}|array{type: 'other'}|null}>, first_id: ?string, last_id: ?string, has_more: bool}  $attributes
     */
     ...
     * {@inheritDoc}
     *
     * @return array{object: string, data: array<int, array{id: string, object: string, usage_bytes: int, created_at: int, vector_store_id: string, status: string, attributes: array<string, string>, last_error: array{code: string, message: string}|null, chunking_strategy: array{type: 'static', static: array{max_chunk_size_tokens: int, chunk_overlap_tokens: int}}|array{type: 'other'}|null}>, first_id: string|null, last_id: string|null, has_more: bool}
     */
